...
- [ ] 5.3 Confirm `grep -rn "startPreferredEvents\|events.*--offline" src/ test/ docs/ README.md` returns nothing outside `docs/charts/old/`, which is a dated as-built record and is left alone.
- [ ] 5.4 Decide the `--notify` open question recorded in the proposal.
