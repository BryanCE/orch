...
- Codex CLI: exact best state-detection mechanism (notify hook vs session-file tail vs wrapper pty) — resolved by spike task, decision recorded back into this doc.
