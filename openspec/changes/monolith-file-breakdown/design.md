...
| `commands/panes.ts` | pure Backend-port geometry: `cmdPanes`, `cmdFocus`, `cmdZoom`, `cmdMove`, `cmdPeek`, `cmdKeys`, `cmdTabs`, `cmdTab`, `selectedGroups`, `resolveTab`, `requirePaneTarget` |
