...
- **Two lock-related features land together** (`agent-spawn-limits` bumps the settings schema concurrently): coordinate the schema constant bump once; whichever change lands second rebases onto the bumped constant rather than double-bumping.
