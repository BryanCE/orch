...
export const commandHandlers: Record<string, Handler> = {
  ...
  runs: (services, args) => dispatchAsync(services.logger, cmdRuns(services, args)),
  ...
  review: (services, args) => dispatchAsync(services.logger, cmdReview(services, args)),
  ...
  abort: (services, args) => dispatchAsync(services.logger, cmdAbort(services, args)),
  ...
  space: (services, args) => dispatchAsync(services.logger, cmdSpace(services, args)),
  clean: (services, args) => cmdClean(services, args),
  grant: (services, args) => dispatchAsync(services.logger, cmdGrant(services, args)),
  settings: (services, args) => dispatchAsync(services.logger, cmdSettings(services, args)),
