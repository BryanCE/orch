...
import { namesPresenceFile, readLatestResult, presenceAgentDir, readPresenceStatus } from "../presence/writer.ts";
...
import { collapse, optionalString, truncate } from "../util.ts";
