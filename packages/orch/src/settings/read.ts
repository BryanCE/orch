...
const settingsValueExtractors = {
  ...
  timeouts: (root: Partial<SettingsFile>) => ({
    ...
    command_lock_ms: root.timeouts?.command_lock_ms ?? SETTINGS_DEFAULTS.timeouts.command_lock_ms,
    command_lock_poll_ms: root.timeouts?.command_lock_poll_ms ?? SETTINGS_DEFAULTS.timeouts.command_lock_poll_ms,
  }),
