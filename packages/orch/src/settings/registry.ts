...
const HELP: Readonly<Record<string, string>> = {
  ...
  "timeouts.command_lock_ms": "How long orch lock waits for a locked command's lock before it gives up, in milliseconds.",
  "timeouts.command_lock_poll_ms": "How often orch lock asks orchd whether the lock is free, in milliseconds.",
