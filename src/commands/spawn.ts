...
import { workerHeaderFor, AgentView } from "../store/agent-view.ts";
import { loadConfig, BackendGroup, BackendHandle, BackendId, GroupLayoutRole, TileFirstSplit, TilePlacement, assertValidAgentName } from "../policy/name.ts";
import { agentIdentityEnv, callerOwnerToken, callerSpace, daemonOutage } from "./daemon.ts";
import { rpcHello } from "../daemon/rpc.ts";
import { registerSpawnedAgent } from "../store/spawn-registration.ts";
import { agentViewIndex, die, planTilePlacement, presenceById } from "./target.ts";
import { resolveTab } from "./panes.ts";
import { commandLogger } from "./logging.ts";
import type { Backend, readGroupLayout } from "../backends/tiling.ts";
...
import { errorMessage, resolveBackend } from "../backends/registry.ts";
import { nextTilePlacement, resolveSetting, serializeIdentity, sleep } from "../util.ts";
import { callDaemon, spawnerIdentity, splitThinkingSuffix, tryParseIdentity } from "../backends/identity.ts";
import { detachedBackend, type OrchConfig } from "../config.ts";
import { assertNameFree, type ThinkingLevel } from "../policy/thinking.ts";
import { workerPolicyFrom, type WorkerHeaderContext } from "../worker-prompt.ts";
import { mintAgentId, type WorkerPolicy } from "../policy/workers.ts";
import { resolveAdapter as resolveRegisteredAdapter } from "../adapters/registry.ts";
import type { AdapterId, workerTools, worktreeEnv } from "../policy/spawner.ts";
import { assertModelAllowed } from "../policy/model.ts";
import { term } from "../policy/vocabulary.ts";
import { resolveThinking } from "../types/backend.ts";
