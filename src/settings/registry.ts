...
const KEYS = [
  ...
  "fleet.pack_cap",
  "fleet.max_agents",
  "fleet.workspace_caps",
  "fleet.worker_peer_tools",
  "fleet.cross_workspace",
  "models.allowed",
  "models.preferred",
...
const HELP: Readonly<Record<string, string>> = {
  ...
  "fleet.workspace_caps": "Agent limits by workspace.",
  "fleet.worker_peer_tools": "Whether workers may use peer tools.",
  "fleet.cross_workspace": "Whether workers may cross workspace boundaries.",
  ...
  workspaces: "Named workspace paths.",
