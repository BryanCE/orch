...
describe("CodexAdapter", () => {
  test("uses the codex launch shapes and declares honest capabilities", () => {
    ...
    expect(adapter.caps).toEqual({ steer: "resume", ask: false, setModel: false, sessionTail: true, registersPresenceOnStart: false, enforcesCommandLocks: false, lifecycle: [] });
